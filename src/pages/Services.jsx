    ...
    <>
      <Flex flexDir={"column"} gap={8} p={8} maxW="90rem" mx="auto">
        ...
        <Card h="20vh" bg="red.600" display="flex" alignItems={{base:'center',md:'center'}} textAlign={{base:'center',md:'center'}} justifyContent={{base:'center',md:'center'}}>
          <Heading color="white" fontSize={{base:'25',sm:'30',md:'35',lg:'40',xl:'45'}} > Servicios de Enfermeria at Home</Heading>
        </Card>
        <Flex gap={4} flexDir={{ base: 'column', md: 'row', }}>
          <Card variant="outline" w="100%" justifyContent={{lg:'center'}} >
            <Flex flexDir="column" p={4}  gap="3rem">
              <Text color="red.600"   fontWeight="600" fontSize={{ base: 25, md: 30,lg:40,xl:45,}}textAlign={{base:'center', md:'center',lg:'center'}} >
                Nuestros Servicios de Enfermería
              </Text>
              <Text fontSize={{ base: 15, md: 20 ,lg:25,xl:30}}textAlign={{base:'justify', md:'justify',lg:'justify',xl:'justify'}}>
        ...
        <Box>
          <Flex gap={4} flexDir={{ base: 'column', md: 'row', }} justifyContent={{lg:'center'}}>
            <Card variant="outline" w="100%" >
              <Flex flexDir="column" p={4}  gap="3rem">
                <Text color="red.600" fontSize={{ base: 25, md: 30,lg:40,xl:45}}textAlign={{base:'center', md:'center',lg:'center',xl:45}} fontWeight="600">
        ...
        <Box>
          <Flex gap={4} flexDir={{ base: 'column', md: 'row', }} >
            <Card variant="outline" w="100%" justifyContent={{lg:'center'}}>
              <Flex flexDir="column" p={4}  gap="3rem">
                <Text color="red.600" fontSize={{ base: 25, md: 30,lg:40,xl:45}}textAlign={{base:'center', md:'center',lg:'center',xl:'center'}} fontWeight="600">
