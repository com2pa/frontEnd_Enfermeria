...
export default function ContactFormWithSocialButtons() {
  ...
  const handleDescriptionInput=({target})=>{
                  ...
                  <VStack spacing={5}>
                    <FormControl isInvalid={!nameValidation && name} isRequired>
                      ...
                      <InputGroup>
                        ...
                        <Input type="text" name="name" placeholder="Jose Colmenares"onChange={handleNameInput} value={name} />
                      </InputGroup>
                    </FormControl>

                    <FormControl isInvalid={!emailValidation && email} isRequired>
                      ...
                      <InputGroup>
                        ...
                        <Input type="email" name="email" placeholder="sisi@gmail.com"  onChange={handleEmailInput} value={email}/>
                      </InputGroup>
                    </FormControl>

                    <FormControl isInvalid={!phoneValidation && phone} isRequired>
                      ...
                      <InputGroup borderColor="#E0E1E7">
                        ...
                        <Input type="text" size="sm" placeholder="04141111111" onChange={handlePhoneInput} value={phone}/>
                      </InputGroup>
                    </FormControl>
                    ...
                    <FormControl isRequired>
                      ...
                      <InputGroup borderColor="#E0E1E7">
                        ...
                        <Input type="text" size="sm"  onChange={handleAgeInput} value={age}/>
                      </InputGroup>
                    </FormControl>
                    <FormControl isRequired>
                    ...
                    <FormControl isRequired>
                      ...
                      <InputGroup borderColor="#E0E1E7">
                        ...
                        <Input type="text" size="sm" onChange={handleAddressInput} value={address}/>
                      </InputGroup>
                    </FormControl>
                    <FormControl >
                      ...
                      <InputGroup borderColor="#E0E1E7" size="sm">
                        ...
                        <Select placeholder="Select option" onChange={({ target }) => setServiceSelected(target.value)}>
                    ...
                    <FormControl isRequired>
                      ...
                      <Textarea
                        ...
                        rows={6}
                        resize="none" onChange={handleDescriptionInput} value={description}
                      />
                    </FormControl>
