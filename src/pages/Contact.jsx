...
export default function ContactFormWithSocialButtons() {
  ...
  const handleNewPatient = async()=>{
    try {
      console.log(1);
      const{data}=await axios.post('/api/patient',{name, email, phone, age, address, description,date});
                  ...
                  <VStack spacing={5}>
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        ...
                        <Input type="text" name="name" placeholder="Your Name"onChange={handleNameInput} value={name} />
                      </InputGroup>
                    </FormControl>
                    ...
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        ...
                        <Input type="email" name="email" placeholder="Your Email"  onChange={handleEmailInput} value={email}/>
                      </InputGroup>
                    </FormControl>
                    ...
                    <FormControl isRequired>
                      ...
                      <InputGroup borderColor="#E0E1E7">
                        ...
                        <Input type="text" size="sm" onChange={handlePhoneInput} value={phone}/>
                      </InputGroup>
                    </FormControl>
